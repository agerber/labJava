...
public class HiddenJavaDriver {
    ...
    //2. If you do not provide a constructor in your class (see below), a default no-arg constructor is provided to you.
    ...
    //3. All classes in Java "extends Object" by default, even Drivers and utility classes.  The 'extends Object' below
