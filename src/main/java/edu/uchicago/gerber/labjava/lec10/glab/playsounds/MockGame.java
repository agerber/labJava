package edu.uchicago.gerber.labjava.lec10.glab.playsounds;
	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                new Thread(new Mp3(System.getProperty("user.dir") + "\\src\\edu.uchicago.gerber.labjava.lec10\\glab\\playsounds\\snds\\gun_plasmafire.mp3")).start();
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Thread(new Mp3(System.getProperty("user.dir") + "\\src\\edu.uchicago.gerber.labjava.lec10\\glab\\playsounds\\snds\\explosion_enormous.mp3")).start();
		...
		btnLoop.addActionListener(new ActionListener() {
			...
			// new Thread(new Mp3Loop(System.getProperty("user.dir")+  "/src/edu/uchicago/cs/java/edu.uchicago.gerber.labjava.lec10/playsounds/snds/loop5.mp3")).start();
				new Thread(new Mp3Loop(System.getProperty("user.dir")+  "\\src\\edu.uchicago.gerber.labjava.lec10\\glab\\playsounds\\snds\\drums09.mp3")).start();
		...
		btnOld.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new Thread(new ClipLoopOldSchool("file://" +   System.getProperty("user.dir") +   "\\src\\edu.uchicago.gerber.labjava.lec10\\glab\\playsounds\\snds\\samisen.au")).start();
			}
		});
