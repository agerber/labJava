...
import edu.uchicago.gerber.labjava.lec03.glab.boxing.Human;
import edu.uchicago.gerber.labjava.lec03.glab.boxing.Kangaroo;
...
//
//
//		racRacers[0] = new Human("//src//edu.uchicago.gerber.labjava.lec03//glab//resources//run_human.gif",
//				Raceable.DIM);
//
//		racRacers[1] = new Gazelle("//src//edu.uchicago.gerber.labjava.lec03//glab//resources//run_gazelle.jpg",
//				Raceable.DIM);
//
//
//		racRacers[2] = new Kangaroo("//src//edu.uchicago.gerber.labjava.lec03//glab//resources//run_roo.png",
//				Raceable.DIM);
//
