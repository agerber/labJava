...
public class StaticInnerLibraryExample {
    ...
    public static void main(String[] args) {
        ...
        List<StaticInnerLibraryExample.Book> arrayList = new ArrayList<>();
        arrayList.add(new StaticInnerLibraryExample.Book("1984", "George Orwell"));
        arrayList.add(new StaticInnerLibraryExample.Book("To Kill a Mockingbird", "Harper Lee"));
