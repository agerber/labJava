...
public class InnerClassLibraryExample {
    private String libraryName;
    private List<Book> books;

    // Constructor for Library
    public InnerClassLibraryExample(String libraryName) {
    ...
    public static void main(String[] args) {
        ...
        InnerClassLibraryExample cityLibrary = new InnerClassLibraryExample("City Library");
