...
public class Fractal extends JFrame {
	...
	public Fractal() {
		...
		changeColorJButton.addActionListener(new ActionListener() //  anonymous  inner  class
				{
					...
					public void actionPerformed(ActionEvent event) {
						Color color = JColorChooser.showDialog(Fractal.this,
		...
		decreaseLevelJButton.addActionListener(new ActionListener() //  anonymous  inner  class
				{
		...
		increaseLevelJButton.addActionListener(new ActionListener() //  anonymous  inner  class
				{
