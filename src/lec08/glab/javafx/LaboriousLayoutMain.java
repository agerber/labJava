...
public class LaboriousLayoutMain extends Application {
    ...
    public static void main(String[] args) {
        launch(LaboriousLayoutMain.class, args);
    }
...
//                    new Image(LaboriousLayoutMain.class.getResourceAsStream("graphics/house.jpg")));
...
//                    new Image(LaboriousLayoutMain.class.getResourceAsStream("styles/piechart.gif")));
...
//                    new Image(LaboriousLayoutMain.class.getResourceAsStream(
